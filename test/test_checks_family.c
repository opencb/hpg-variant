...
START_TEST (mendel_type_3) {
    ...
    fail_if(check_mendel("20", 1, 1, 1, 1, 0, 0, FEMALE) != 3,    "11x11 -> 00 is a mendel error 3");
}
END_TEST

START_TEST (mendel_type_4) {
    fail_if(check_mendel("20", 1, 1, 0, 0, 0, 0, FEMALE) != 3,    "11x00 -> 00 is a mendel error 4");
    fail_if(check_mendel("20", 1, 1, 0, 1, 0, 0, FEMALE) != 3,    "11x01 -> 00 is a mendel error 4");
    fail_if(check_mendel("20", 1, 1, 1, 0, 0, 0, FEMALE) != 3,    "11x10 -> 00 is a mendel error 4");
    fail_if(check_mendel("20", 1, 1, 1, 1, 0, 0, FEMALE) != 4,    "11x11 -> 00 is a mendel error 4");
}
END_TEST
