...
MISC_OBJS = $(COMMONS_DIR)/file_utils.o $(COMMONS_DIR)/http_utils.o $(COMMONS_DIR)/log.o $(COMMONS_DIR)/string_utils.o $(CONTAINERS_DIR)/list.o \
...
FILTER_OBJS = main_filter.o filter_runner.o filter_options_parsing.o main_split.o split.o split_runner.o split_options_parsing.o \
	main_stats.o stats_runner.o stats_options_parsing.o
