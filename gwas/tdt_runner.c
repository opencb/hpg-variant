...
#pragma omp parallel num_threads(shared_options_data->num_threads)
            ...
            // TODO this for loop provides good speed-up
//             for (int i = 0; i < 100000000 / omp_get_num_threads(); i++) {
...
//                 for (i = 0; i < 10; i++) {
                    execute_vcf_ragel_machine(text_begin, text_end_batch, vcf_batches_list, shared_options_data->batch_size, file, status);
//                 }
//                 
